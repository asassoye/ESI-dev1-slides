...
\begin{document}
    ...
    \import{contents/declaration-et-creation/}{introduction}
        \subsection{Déclaration de tableaux}\label{subsec:declaration-de-tableaux}
    \import{contents/declaration-et-creation/}{declaration-de-tableaux.tex}
        \subsection{Création de tableaux}\label{subsec:creation-de-tableaux}
    \import{contents/declaration-et-creation/}{creation-de-tableaux.tex}
