\begin{frame}{Création par l'operateur new}
    ...
    \lstinputlisting[firstline=9, lastline=9, firstnumber=9, morekeywords=Scanner]{contents/declaration-et-creation/java/OperateurNew.java}
...
\begin{frame}{Création par l'operateur new}{Code complet}
    \lstinputlisting[morekeywords=Scanner]{contents/declaration-et-creation/java/OperateurNew.java}
\end{frame}
...
\begin{frame}{Utilisation d'un initialiseur}
    ...
    \lstinputlisting[morekeywords=Scanner]{contents/declaration-et-creation/java/Initialiseur.java}
...
\begin{frame}{Utilisation d'un initialiseur}{Variante sans initialiseur}
    ...
    \lstinputlisting[morekeywords=Scanner]{contents/declaration-et-creation/java/SansInitialiseur.java}
\end{frame}